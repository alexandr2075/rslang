...
export default class AudioCall extends createComponent {
  ...
  render() {
    ...
    <section class='question-container'>
        <h1 class='question'>${this.word}</h1>
        <img src="${this.image}">
        <section class='multiple-choice'>${this.wordTranslate}</section>
    </section>
    <section class='intro conclusion'></section>
</div>
 `;
  }
}
